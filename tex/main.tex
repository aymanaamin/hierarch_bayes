...
\end{align}
$\Lambda$ is treated as a hyperparameter and discussed in greater detail in subsection \ref{sec:weighting}. The likelihood function for the data is then given by 
\begin{align*}
...
\end{align*}
 The joint posterior distribution is accordingly
\begin{align*}
...
\begin{figure}[H]
	...
	\caption{\textbf{Regional and Categorical Composition of Swiss Goods Exports}}\label{fig:treemap}
\end{figure}
...
\end{figure}
  ...
  \begin{figure}[H]
 	\includegraphics[width=\textwidth]{fig/fig_forecast}
 	\caption[Forecast for Exports of Machinery, Appliances and Electronics]{\textbf{Forecast for Exports of Machinery, Appliances and Electronics}. Grey ribbons indicate 80, 90, 95 and 99 percentile confidence intervals.}\label{fig:regions}
 \end{figure}
 
 Todo:
 \begin{itemize}
 	\item Forecast experiment
 \end{itemize}

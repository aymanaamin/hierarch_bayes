...
\end{align*}
The hyperparameter $\Lambda$ is discussed in greater detail in subsection \ref{sec:weighting}, but it is crucial to note that it affects the covariance matrix of the distribution, but not the mean. This special case arises because the reconciliation equation provides a perfect fit for the prediction mean. The posterior distribution is accordingly
\begin{align*}
